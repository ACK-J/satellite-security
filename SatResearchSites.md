...
- https://skystar-2.com/satellite-internet-SkyGrabber_v3.1.zip.html

Emulation and simulation tools
- CSP (CubeSat Space Protocol) - https://github.com/libcsp/libcsp - protocol-level security
- https://rfquack.org/ - versatile open-source SDR toolkit (hardware + firmware) for flexible wireless protocol analysis

Cool stuff
- https://github.com/palacita135/HackRF-and-RTL-SDR-to-scan-satellite-signals
- https://www.sellmylaptops.com/blog/satellite-hacking-risks-real-world-examples-and-how-to-stay-safe
- https://kalilinuxtutorials.com/hackers-sat/
- https://forum.defcon.org/node/232077
- https://blog.redteamguides.com/p/satellite-hacking-demystified
...
- https://arxiv.org/abs/2312.01330
- https://arxiv.org/abs/2301.03672 - satellite physical security layer explained


Training
- https://ceur-ws.org/Vol-3731/paper18.pdf - open cyber‑range designed to simulate satellite communication networks
- https://arxiv.org/abs/2505.24008 - high‑interaction satellite honeypot framework capable of convincingly simulating CubeSat missions
- https://medium.com/@amiedd/open-source-satellite-hacking-virtual-machine-d26d96d90295 - Open Source Satellite Hacking Virtual Machine


Paid Course
- https://pentestmag.com/course/aerospace-cybersecurity-satellite-hacking-w53/
